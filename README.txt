...
When you run the binary you can enter a Phrase that is then AES256 encrypted , the cyphertext is printed out, it is decrypted,  and the decrypted text is printed out